...
curl -sL "${BASE_URL}/xterm@${XTERM_VERSION}/css/xterm.css" -o "${ASSETS_DIR}/xterm.css"
curl -sL "${BASE_URL}/xterm@${XTERM_VERSION}/lib/xterm.js" -o "${ASSETS_DIR}/xterm.js"
curl -sL "${BASE_URL}/@xterm/addon-fit@0.10.0/lib/addon-fit.js" -o "${ASSETS_DIR}/xterm-addon-fit.js"
curl -sL "${BASE_URL}/@xterm/addon-web-links@0.11.0/lib/addon-web-links.js" -o "${ASSETS_DIR}/xterm-addon-web-links.js"
